...
namespace AdvancedAstrologyAndHoroscopeLib\Controllers;

use AdvancedAstrologyAndHoroscopeLib\APIException;
use AdvancedAstrologyAndHoroscopeLib\APIHelper;
use AdvancedAstrologyAndHoroscopeLib\Configuration;
use Unirest\Unirest;
class APIController {
    ...
    public function createAdvancedPanchangAtTheTimeOfSunrise (
                $jSONRequestForPanchangAtSunrise) 
    {
     ...
     * @return mixed response from the API call*/
    public function createAshtakootDetails (
                $jSONRequestForMatchMaking) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @return mixed response from the API call*/
    public function createBasicAstrologicalDetails (
                $jSONRequestData) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestData       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createBasicGemstoneSuggestion (
                $jSONRequestData) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @return mixed response from the API call*/
    public function createBasicPanchangDetails (
                $jSONRequestForPanchang) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForPanchangAtSunrise          Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createBasicPanchangDetailsAtTheTimeOfSunrise (
                $jSONRequestForPanchangAtSunrise) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestData       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createBirthDetails (
                $jSONRequestData) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForPanchang        Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createCompletePanchangDetails (
                $jSONRequestForPanchang) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestData       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createCurrentVimshottariDasha (
                $jSONRequestData) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @return mixed response from the API call*/
    public function createFastsReport (
                $jSONRequestForNumerology) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForNumerology        Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createFavourableLord (
                $jSONRequestForNumerology) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForNumerology        Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createFavourableMantra (
                $jSONRequestForNumerology) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForNumerology        Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createFavourableTime (
                $jSONRequestForNumerology) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @return mixed response from the API call*/
    public function createGeneralHouseReport (
                $options) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed      $options['jSONRequestData']       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createGeneralRashiReport (
                $options) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestData       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createGetPlanetaryPositions (
                $jSONRequestData) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed      $options['jSONRequestData']       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createHoroscopeCharts (
                $options) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestData       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createKalsarpaDoshaReport (
                $jSONRequestData) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestData       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createMajorVimshottariDashaDetails (
                $jSONRequestData) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestData       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createManglikReport (
                $jSONRequestData) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForMatchMaking         Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createMatchMakingReport (
                $jSONRequestForMatchMaking) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForMatchMaking         Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createMatchManglikReport (
                $jSONRequestForMatchMaking) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForMatchMaking         Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createMatchingAstrologyDetails (
                $jSONRequestForMatchMaking) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForMatchMaking         Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createMatchingBirthDetails (
                $jSONRequestForMatchMaking) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForMatchMaking         Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createMatchingObstruction (
                $jSONRequestForMatchMaking) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForMatchMaking         Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createMatchingPlanetaryDetails (
                $jSONRequestForMatchMaking) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForNumerology        Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createNumerologyBasicDetails (
                $jSONRequestForNumerology) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForNumerology        Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createNumerologyReport (
                $jSONRequestForNumerology) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForNumerology        Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createPlaceAndVastu (
                $jSONRequestForNumerology) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForPanchangAtSunrise          Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createPlanetPanchangDetailsAtTheTimeOfSunrise (
                $jSONRequestForPanchangAtSunrise) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestForPanchang        Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createPlanetaryPanchangDetails (
                $jSONRequestForPanchang) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
     ...
     * @param  mixed     $jSONRequestData       Required parameter: The details in below format is required to be sent in JSON format for making an API request.
     * @return mixed response from the API call*/
    public function createRudrakshaSuggestion (
                $jSONRequestData) 
    {
        //the base uri for api requests
        $queryBuilder = Configuration::BASEURI;
